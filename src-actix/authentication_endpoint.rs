...
use crate::authentication::access_tokens::{
    generate_unique_registration_access_token, get_all_access_tokens,
};
use crate::authentication::data::{UserLogin, UserRegistration};
...
#[post("/login")]
pub async fn login(body: web::Json<UserLogin>, req: HttpRequest) -> Result<impl Responder> {
...
pub fn configure(cfg: &mut web::ServiceConfig) {
    cfg.service(
        web::scope("auth")
            ...
            .service(check_if_access_token_exists)
            .service(get_users),
    );
}
