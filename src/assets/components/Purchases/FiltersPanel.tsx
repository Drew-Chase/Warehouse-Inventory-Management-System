...
export default function FiltersPanel()
{
    ...
    return (
        <div className={"flex flex-col min-w-[300px] w-1/4 h-full ml-4"}>
            ...
            <div className={"flex flex-col shadow-lg bg-background-L100 min-h-[200px] w-full rounded-2xl p-4 max-h-[calc(100vh_-_160px)] h-[100vh] overflow-y-auto pr-5 mt-3"}>
